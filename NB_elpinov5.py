...
def main():
    ...
    # Vectorizar texto
    vectorizador = CountVectorizer(max_features=10000, ngram_range=(1,1))
    ...
    #guarda modelo
    joblib.dump(modelo, "modelo_NB.pkl")
    ...
    plt.title("Matriz de Confusión - Top 10 GRD - Naive Bayes")
    plt.xlabel("Predicha")
    plt.ylabel("Real")
    plt.show()

    # saca 10 clases menos frecuentes
    ...
    # Matriz top 10 menos frecuentes
    ...
    plt.xlabel("Predicha")
    plt.ylabel("Real")
    plt.title("Matriz de Confusión - peores 10 GRD - Naive Bayes")
    plt.show()
